    ...
    def backTrackFunction(self, startingNode):
        ...
        while toNode is not None:
            ...
            for j in range (2):
                ...
                check1 = ((img[oneThird_x,oneThird_y] != allowed_color).all() or ((img[oneThird_x,oneThird_y] > green_range_high).all() and (img[oneThird_x,oneThird_y] < green_range_low).all()) or ((img[oneThird_x,oneThird_y] > red_range_high).all() and (img[oneThird_x,oneThird_y] < red_range_low).all()))
                check2 = ((img[twoThird_x,twoThird_y] != allowed_color).all() or ((img[twoThird_x,twoThird_y] > green_range_high).all() and (img[twoThird_x,twoThird_y] < green_range_low).all()) or ((img[twoThird_x,twoThird_y] > red_range_high).all() and (img[twoThird_x,twoThird_y] < red_range_low).all()))
...
def startFunction():
    ...
    letsGoFromStart.start(445,55,0) 
    letsGoFromEnd.start(525,615,0)
